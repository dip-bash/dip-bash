...
def add_archive():
    """
    Adds archived repositories using their last known data
    """
...
def stars_counter(data):
    """
    Count total stars in repositories owned by me (Safe Version)
    """
    total_stars = 0
    if not data:
        return total_stars
...
if __name__ == "__main__":
    ...
    # Calculate age/uptime (Change the hardcoded birthday to yours if desired)
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2003, 5, 19))
    ...
    # Generate the Markdown file instead of SVGs
    generate_markdown(
        "README.md",
        age_data,
        "{:,}".format(commit_data),
